...
const MAVActiveUsers = ({ dailyData, weeklyData, monthlyData }) => {
    ...
    <div>
      ...
      <div className="chart_statistics">
        <div className="chart_statistics_item">
          <p className="text-4xl font-semibold mt-2 text-slate-700">{totalUsers}</p>
          <p className="text-base font-normal text-slate-500">Total Users</p>
        </div>
        <div className="chart_statistics_item">
